...
CREATE UNIQUE INDEX "idx_admin_accounts_issuer_account" ON "admin_accounts" USING btree ("issuer","account_id");--> statement-breakpoint
CREATE INDEX "idx_admin_accounts_user" ON "admin_accounts" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_admin_sessions_user" ON "admin_sessions" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_admin_verifications_identifier" ON "admin_verifications" USING btree ("identifier");